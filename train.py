...
from model.SplitGNN_3_5 import SplitGNN_3_5
...
def get_model():
    ...
    elif exp_model == 'SplitGNN_3.3':
        return SplitGNN_3_3(hist_len, pred_len, in_dim, city_num, batch_size, device, graph.edge_index, graph.edge_attr, wind_mean, wind_std, node_gru_hidden_dim, edge_gru_hidden_dim, edge_mlp_hidden_dim)
